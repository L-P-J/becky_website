      ...
      <header className="border-b border-[#f2d7a5]/60 bg-white/90 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-5">
          <nav className="hidden items-center gap-8 text-sm font-semibold text-ink-muted md:flex">
            <a
              className="transition-colors hover:bg-amber-200 rounded-full px-2 py-2"
              href="#education"
            >
              Education & Skills
            </a>
          ...
          <div>
            ...
            <div className="mt-8 space-y-6">
              {skills.map((group) => (
                ...
                >
                  <h3 className="text-base font-semibold text-primary md:self-start">
                    {group.category}
                  </h3>
                  <div className="flex flex-wrap gap-3 md:items-start">
                    {group.items.map((item) => (
                      <span
                        key={item}
                        className="rounded-full bg-white px-3 py-1 text-sm font-semibold text-primary shadow-[0_6px_14px_rgba(242,175,77,0.18)]"
                      >
                        {item}
                      </span>
                    ))}
